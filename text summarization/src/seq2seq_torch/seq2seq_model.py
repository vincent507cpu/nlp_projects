...
class Seq2Seq(nn.Module):
    def __init__(self, params, vocab):
        super().__init__()
        self.embed_matrix = torch.tensor(load_embedding_matrix())
        self.params = params
        self.vocab = vocab
...
if __name__ == '__main__':
    ...
    # example_input
    exp_input_batch = torch.ones((params['batch_size'], params['input_sequence_len'])).long()
    ...
    # decoder layer
    sample_decoder_output, _, _ = model.decoder(torch.randint(0, vocab_size, (params['batch_size'], 1)).long(),
